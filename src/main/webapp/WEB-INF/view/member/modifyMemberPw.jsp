...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<h1 class="page-section-heading text-center text-uppercase text-secondary mb-0" style="margin-top:150px;">비밀번호 수정</h1>
			<!-- Icon Divider-->
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					<form id="contactForm" data-sb-form-api-token="API_TOKEN" action="${pageContext.request.contextPath}/member/modifyMemberPw" method="post">
					<!-- Id css -->
					...
					<!-- 비밀번호css -->
					<div class="form-floating mb-3">
						<input class="form-control" id="upPw" type="password" name="updatePw" placeholder="name@example.com" data-sb-validations="required,email" />
						<span class="msg" id="upPwMsg"></span>
						<label for="upPw">updatePw</label>
					</div>
					<!-- 비밀번호css -->
					<div class="form-floating mb-3">
					...
					<!-- Submit Button-->
					<div align="center">
						<button class="btn btn-primary btn-xl" id="submitButton" type="submit">비밀번호수정</button>
					</div>
					</form>
				</div>
			</div>
